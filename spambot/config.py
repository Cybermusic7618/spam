...
class Config(object):
    ...
    BOT_TOKEN6 = os.environ.get("BOT_TOKEN5", None)
    BOT_TOKEN7 = os.environ.get("BOT_TOKEN5", None)
    BOT_TOKEN8 = os.environ.get("BOT_TOKEN5", None)
    BOT_TOKEN9 = os.environ.get("BOT_TOKEN5", None)
    BOT_TOKEN10 = os.environ.get("BOT_TOKEN5", None)
